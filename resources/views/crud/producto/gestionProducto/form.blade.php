<div class="form-group mb-2">
    ...
    <input type="text" name="nombre_producto{{$tipo}}" id="nombre_producto{{$tipo}}" class="form-control @error('nombre_producto'.$tipo) is-invalid @enderror" value="{{isset($producto->nombre_producto)?$producto->nombre_producto:old('nombre_producto'.$tipo)}}" title="Nombre que va a llevar el producto">
...
<div class="form-group mb-2">
    ...
    <select name="tipo_producto_id{{$tipo}}" id="tipo_producto_id{{$tipo}}" class="form-control  @error('tipo_producto_id'.$tipo) is-invalid @enderror" title="Tipo de producto que es">
        <?php
...
<div class="form-group mb-2">
    ...
    <input type="number" name="precio_producto{{$tipo}}" id="precio_producto{{$tipo}}" class="form-control  @error('precio_producto'.$tipo) is-invalid @enderror" value="{{isset($producto->precio_producto)?$producto->precio_producto:''}}" title="Precio de venta del producto">
...
<div class="form-group mb-2">
    ...
    <select name="estado_producto{{$tipo}}" id="estado_producto{{$tipo}}" class="form-control @error('estado_producto'.$tipo) is-invalid @enderror" title="Estado del producto (actual)">
        <?php
