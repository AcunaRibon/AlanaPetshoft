<div class="form-group mb-2">
        ...
        <input type="text" name="nombre_producto" id="nombre_producto" class="form-control" value="{{isset($producto->nombre_producto)?$producto->nombre_producto:''}}">
    </div>
    <div class="form-group mb-2">
        <label for="url_imagen_producto">Foto:</label>
        {{isset($producto->url_imagen_producto)?$producto->url_imagen_producto:''}}
        <input type="file" name="url_imagen_producto" id="url_imagen_producto" class="form-control" value="{{isset($producto->url_imagen_producto)?$producto->url_imagen_producto:''}}">
    </div>
    <div class="form-group mb-2">
    ...
    <div class="form-group mb-2">
        ...
        <input type="number" name="precio_producto" id="precio_producto" class="form-control" value="{{isset($producto->precio_producto)?$producto->precio_producto:''}}">
    </div>
    <div class="form-group mb-2">
